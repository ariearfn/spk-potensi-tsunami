...
$result = mysqli_query($mysqli, "SELECT * FROM tb_input ORDER BY id ASC"); // using mysqli_query instead
?>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-12">
      ...
      <h3 class="card-title">RIWAYAT PERHITUNGAN</h3>
      </div>  
          ...
          <table class="table table-head-fixed text-nowrap">
            ...
            <tbody>
              ...
              <?php
                ...
                $no = 1;
                $q = $mysqli->query("SELECT * FROM tb_input");
                ...
                <tr>  
                  <td><?php echo $no++;?></td>
                  <td><?= $res['DGB'] ?></td>
                  <td><?= getKategori($res['JS']) ?></td>
                  <td><?= $res['K'] ?></td>
                  <td><?= $res['M'] ?></td>
                  <td><?= $res['Latitude'] ?></td>
                  <td><?= $res['Longitude'] ?></td>
                  <td><?= getLabel1($res['Label']) ?></td>
